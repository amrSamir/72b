...
public class RegistrationView extends Composite implements RegistrationPresenter.Display {
	...
	/* (non-Javadoc)
     * @see com.OJToolkit.client.presenter.RegistrationPresenter.Display#getSubmitButton()
     */
    @Override
	...
	/* (non-Javadoc)
     * @see com.OJToolkit.client.presenter.RegistrationPresenter.Display#getUsername()
     */
    @Override
	...
	/* (non-Javadoc)
     * @see com.OJToolkit.client.presenter.RegistrationPresenter.Display#getSPOJUsername()
     */
    @Override
    public HasValue<String> getSPOJUsername() {
	    // TODO Auto-generated method stub
	    return txtSPOJUsername;
    }

	/* (non-Javadoc)
     * @see com.OJToolkit.client.presenter.RegistrationPresenter.Display#getSPOJPassword()
     */
    @Override
    public HasValue<String> getSPOJPassword() {
	    // TODO Auto-generated method stub
	    return pwdSPOJ;
    }
