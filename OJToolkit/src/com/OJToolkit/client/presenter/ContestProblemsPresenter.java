...
public class ContestProblemsPresenter implements Presenter {
	...
	public ContestProblemsPresenter(SubmissionServiceAsync submissionService,ContestServicesAsync contestService
		        ...
		        .addSelectionChangeHandler(new SelectionChangeEvent.Handler() {
			        ...
			        public void onSelectionChange(SelectionChangeEvent event) {
				        ProblemData problemData = selectionModel
				                .getSelectedObject();
				        contestService.addProblemToContest(contestList.get(contestsList.getSelectedIndex()).getContestName(), problemData.getProblemCode(),problemData.getOjType() ,new AsyncCallback<Boolean>() {
							...
							public void onFailure(Throwable caught) {
								System.out.println("Magdi-Problem failed to add");
							}
						} );
			        }
		        });
