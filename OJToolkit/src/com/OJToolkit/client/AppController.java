...
//	remembers cookie for 2 weeks.
	public static final Date COOKIES_EXPIRYDATE = new Date(System.currentTimeMillis() + 1000 * 60 * 60);
	...
	public void onValueChange(ValueChangeEvent<String> event) {
		...
		if (token != null) {
			...
			if (token.equals("login")) {
				presenter = new LoginPresenter(loginService, coderService, eventBus, new LoginView());
