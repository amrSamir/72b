 ...
 * May 10, 2011
 */
public class ProblemSubmissionStatusView extends Composite implements ProblemSubmissionStatusPresenter.Display{
	...
	/* (non-Javadoc)
     * @see com.OJToolkit.client.presenter.ProblemSubmissionStatusPresenter.Display#getRefreshButton()
     */
    @Override
	...
	/* (non-Javadoc)
     * @see com.OJToolkit.client.presenter.ProblemSubmissionStatusPresenter.Display#setSubmissionResult(com.OJToolkit.client.ValueObjects.ProblemStatusData)
     */
    @Override
